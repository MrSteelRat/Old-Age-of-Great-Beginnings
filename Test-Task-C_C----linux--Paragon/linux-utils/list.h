...
static inline bool __list_add_valid(struct list_head *new_head,
 ...
 * @new_head : the new element to insert
 *
...
#define list_next_entry_circular(pos, head, member)               \
	(list_is_last(&(pos)->member, head) ?                     \
		 list_first_entry(head, __typeof__(*(pos)), member) : \
...
#define list_prev_entry_circular(pos, head, member)              \
	(list_is_first(&(pos)->member, head) ?                   \
		 list_last_entry(head, __typeof__(*(pos)), member) : \
 ...
 * @head:	the head for your list.
 */
static inline unsigned list_count_nodes(struct list_head *head)
{
